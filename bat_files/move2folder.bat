...
ssh benign "cd ~/Desktop/data && mkdir %name% && mv c*/ %name%/ && mv spoofing/ %name%/"
ssh attacker "cd ~/Desktop/data && mkdir %name% && mv c*/ %name%/ && mv spoofing/ %name%/"
ssh loadbalancer "cd ~/Desktop/data && mkdir %name% && mv c*/ %name%/ && mv spoofing/ %name%/"